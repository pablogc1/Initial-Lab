# -*- coding: utf-8 -*-
"""
Created on Fri Aug 30 18:53:00 2024
...
# Function to run all comparisons for a specified number of iterations and a range of num_sets
def run_comparisons(iterations=1, num_sets_range=[10, 20]):
    ...
    for num_sets in num_sets_range:
        for iteration in range(iterations):
            print(f"\n--- Iteration {iteration + 1}/{iterations} for num_sets={num_sets} ---\n")
                    ...
                    for size in sizes:
                        for comparison_strategy in comparison_strategies:
                            for continuous in continuous_options:
                                params_description = (f"Iteration {iteration + 1}, num_sets={num_sets}, Running with {constraint}, "
...
# Example of running the comparisons 5 times for num_sets in [10, 100, 1000]
run_comparisons(iterations=5, num_sets_range=[10, 20])