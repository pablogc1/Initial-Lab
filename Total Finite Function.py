# -*- coding: utf-8 -*-
"""
Created on Sat Aug 31 11:52:27 2024
...
def compare_sets(num_sets, num_elements, f, differentiation='weak', comparison_strategy='one_vs_all'):
...
# Function to run all comparisons for a specified number of num_sets and num_elements
def run_comparisons(num_sets_range=[10, 20], num_elements_range=[2, 3], f=None):
        ...
        for num_elements in num_elements_range:
            for differentiation in differentiations:
                for comparison_strategy in comparison_strategies:
                    params_description = (f"Running with num_sets={num_sets}, num_elements={num_elements}, "
                    ...
                    result, data_output, x_vals, y_vals, title = compare_sets(
                        num_sets, num_elements, f, differentiation=differentiation,
...
def custom_function(x):
    return (x + 4)  # You can replace this with any function you like

# Run comparisons with the custom function, varying num_sets, num_elements, and other parameters
run_comparisons(num_sets_range=[10, 20], num_elements_range=[2, 3], f=custom_function)
