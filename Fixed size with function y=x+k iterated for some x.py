# -*- coding: utf-8 -*-
"""
Created on Mon Aug 26 20:01:07 2024
...
def compare_set_1_with_others_for_range(num_sets, num_elements, max_increment):
    plt.figure(figsize=(10, 6))

    for increment in range(1, max_increment + 1):  # Loop through the range of increments
    ...
    plt.title(f'Set 1 vs Other Sets for Increments 1 to {max_increment}')
...
max_increment = 50  # Maximum increment value

compare_set_1_with_others_for_range(num_sets, num_elements, max_increment)
