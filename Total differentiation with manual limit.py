# -*- coding: utf-8 -*-
"""
Created on Sun Aug 18 20:40:22 2024
...
def process_levels_until_c(set_num_a, set_num_b, max_levels):
...
# Example usage with up to 10 levels:
max_levels = 10  # Specify the maximum number of levels to process
process_levels_until_c(1, 2, max_levels)
