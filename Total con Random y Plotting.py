# -*- coding: utf-8 -*-
"""
Created on Fri Aug 30 16:47:04 2024
...
# Example usage to iterate over all combinations and save the results:
constraints = ['weighted', 'unconstrained', 'uniqueness', 'strict_uniqueness']
        ...
        for size in sizes:
            for comparison_strategy in comparison_strategies:
                for continuous in continuous_options:
                    params_description = (f"Running with {constraint}, {differentiation} differentiation, "
