# -*- coding: utf-8 -*-
"""
Created on Sun Aug 18 20:48:40 2024
...
def process_levels_until_c(set_num_a, set_num_b, num_sets, num_elements):
    # Generate the sets
    list_of_sets = generate_sets(num_sets, num_elements)
    ...
    sets_dict = {i: list(list_of_sets[i]) for i in range(num_sets)}
...
process_levels_until_c(1, 2, num_sets, num_elements)
