# -*- coding: utf-8 -*-
"""
Created on Mon Aug 19 22:02:37 2024
...
def generate_sets(num_sets, min_elements, max_elements, weighted_numbers, weight_factor):
...
def compare_all_sets(num_sets, min_elements, max_elements, weighted_numbers, weight_factor):
    sets_list = generate_sets(num_sets, min_elements, max_elements, weighted_numbers, weight_factor)
...
weight_factor = 20  # Increase frequency of selected numbers by this factor

compare_all_sets(num_sets, min_elements, max_elements, weighted_numbers, weight_factor)
