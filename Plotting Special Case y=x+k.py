# -*- coding: utf-8 -*-
"""
Created on Sat Aug 31 13:08:31 2024
...
def plot_data_based_on_tags(data, selected_tags, num_sets=None, num_elements=None, k_value=None, plot_all_num_sets=False, plot_all_num_elements=False, plot_all_k_values=False):
    plots_made = False
    for entry in data:
        if tags_match(selected_tags, entry['description']):
            ...
            if entry['type'] == 'all_vs_all':
                ...
                label = f"k={entry['k_value']}, num_elements={entry['num_elements']}" if plot_all_k_values or plot_all_num_elements else f"k={entry['k_value']}"
...
def main():
    ...
    plot_data_based_on_tags(data, selected_tags, num_sets=num_sets, num_elements=num_elements, k_value=k_value, plot_all_num_sets=plot_all_num_sets, plot_all_num_elements=plot_all_num_elements, plot_all_k_values=plot_all_k_values)
